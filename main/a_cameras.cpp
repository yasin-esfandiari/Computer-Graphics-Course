...
void a_cameras() {
    ...
    r1.test_render2(img);
    r1.test_render2(low);
    img.writeEXR("a1-2.exr");
    low.writeEXR("a1-2-low.exr");
    ...
    FishEyeCamera fcam(Point(0, 0, 0), Vector(0.5f, 0.5f, 0.3f), Vector(0, 0, 1), 10.f);
    Renderer r3(&fcam,0);
    r3.test_render2(img);
    img.writeEXR("a1-5.exr");

    EnvironmentCamera ecam(Point(0, 0, 0), Vector(0.5f, 0.5f, 0.3f), Vector(0, 0, 1), 10.f, 10.f);
    Renderer r4(&ecam,0);
    r4.test_render2(img);
