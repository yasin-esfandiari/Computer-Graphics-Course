...
void a_lighting() {
    renderCornellboxA(0.0001f, "lighting-1.exr");
    renderCornellboxA(0.001f, "lighting-2.exr");
    renderCornellboxB(0.0001f, "lighting-3.exr");
    renderCornellboxB(0.001f, "lighting-4.exr");
}