...
void a_mappers() {
    trynomapper("mapper-none.exr");
    trymapper("mapper-nullptr.exr", nullptr, nullptr);
    trymapper("mapper-plane.exr",
    ...
    trymapper("mapper-cylindrical.exr",
    ...
    trymapper("mapper-spherical.exr",
