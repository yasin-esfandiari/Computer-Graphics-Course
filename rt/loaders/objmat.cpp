...
namespace {
    ...
    public:
        std::string name;
        MaterialInfo() : diffuse_(nullptr), ambient_(nullptr), specular_(nullptr), specularExp_(1.0f) {}
        Texture* diffuse() { return diffuse_; }
        Texture* ambient() { return ambient_; }
        Texture* specular() { return specular_; }
        float specularExp() const { return specularExp_; }
        void setSpecularExp(float e) { specularExp_ = e; }
        ...
        void drop() { name=""; specularExp_=1.0f; diffuse_ = nullptr; ambient_ = nullptr; specular_ = nullptr; }
    private:
        Texture* diffuse_;
        Texture* ambient_;
        Texture* specular_;
